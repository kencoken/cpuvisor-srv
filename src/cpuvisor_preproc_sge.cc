...
DEFINE_bool(compchunks, true, "Compute chunks (if false, just attempts to combine existing chunks)");
DEFINE_bool(mergechunks, true, "Merge chunks");
